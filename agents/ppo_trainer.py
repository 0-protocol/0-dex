...
Generalised Advantage Estimation (GAE).  Multiple environment workers
collect rollouts in parallel — mirroring the federated gradient
...
An A3C baseline is available by setting ``algorithm='a3c'``.
"""
